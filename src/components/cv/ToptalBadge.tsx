...
const TOPTAL_PROFILE_URL =
  "https://www.toptal.com/designers/resume/haris-ovcina#N0yWdp"
...
const faceStyle: CSSProperties = {
  ...
  // Proxima Nova is Toptal's brand face; the stack falls back to the site's own
  // sans if the Typekit stylesheet is blocked or slow.
...
export function ToptalBadge() {
  return (
    <div className="inline-block p-1.5" style={borderStyle}>
      ...
      <link
        rel="stylesheet"
        href="https://use.typekit.net/kmj5qkr.css"
        precedence="default"
      />
